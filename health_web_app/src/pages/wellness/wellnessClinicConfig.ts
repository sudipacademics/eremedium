...
export const WELLNESS_CLINIC_CONFIGS: Record<string, WellnessClinicConfig> = {
  ...
  physiotherapy: {
    ...
    kicker: 'Remedium Care',
    headline: 'Recover with a clear blueprint',
    lead: 'Assessment-led physiotherapy and rehab at Remedium Care — Recovery Blueprint, tech-led zones, and session-tracked progress.',
    heroImage: '/wellness/care-hero.svg',
    heroFallback: '/wellness/physiotherapy.svg',
    departmentName: 'Physiotherapy & Rehabilitation',
    theme: 'clinic',
    stickyTitle: 'Start your Care journey',
    stickySub: 'Book an assessment — Recovery Blueprint on day one.',
    trust: [
      { title: 'Assessment first', text: 'Every plan starts with how you move and what hurts.' },
      { title: 'Recovery Blueprint', text: 'Standard or Advanced Tech-Led packages with a clear timeline.' },
      { title: 'Three clinical zones', text: 'Electrotherapy, advanced modalities, and active gait rehab.' },
      { title: 'Transparent rates', text: 'Session and pack pricing upfront before you confirm.' },
      { title: 'Progress you can see', text: 'Baseline vs current metrics after your treatment block.' },
    ],
    tabs: [
    ...
    concerns: [
      { tab: 'Spine', label: 'Back pain', query: 'back', image: '/wellness/care-hero.svg' },
      { tab: 'Spine', label: 'Neck strain', query: 'neck', image: '/wellness/care-hero.svg' },
      { tab: 'Joints', label: 'Knee care', query: 'knee', image: '/wellness/care-hero.svg' },
      { tab: 'Sports', label: 'Sports injury', query: 'sport', image: '/wellness/care-hero.svg' },
      { tab: 'Posture', label: 'Desk posture', query: 'posture', image: '/wellness/care-hero.svg' },
    ],
    quotes: [
      { quote: 'Clear Recovery Blueprint after the first assessment.', name: 'Vikram S.', focus: 'Back rehab' },
    ...
    hubTeaser: 'Remedium Care — Recovery Blueprint, rehab zones, and tracked progress.',
  },
